...
namespace CMCWeb.ServiceAccess
{
#pragma warning disable
    ...
    public partial class Client
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<string> DownloadJobFileResultAsync(string filename, string jobId, string fileToWriteTo)
        {
            return DownloadJobFileResultAsync(filename, jobId, System.Threading.CancellationToken.None, fileToWriteTo);
        }
